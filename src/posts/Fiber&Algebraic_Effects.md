...
![optical_fiber](https://drive.useyourself.cn/optical_fiber.jpeg)
...
![fiber](https://drive.useyourself.cn/fiber.png)

Emm...

![abstract](https://drive.useyourself.cn/abstract.gif)
...
![Coroutine](https://drive.useyourself.cn/Coroutine.png)
...
![stack](https://drive.useyourself.cn/stack.png)
...
![fiber](https://drive.useyourself.cn/fiber.gif)
...
![fiber_flow](https://drive.useyourself.cn/fiber_flow.png)
...
![algebraic_effect](https://drive.useyourself.cn/algebraic_effect.png)
...
这段**目前并不存在**的语法表示的是，对于 `getX` 产生的效应，由 handle 块进行处理，并加上了一些逻辑，最后通过 `resume` 运算符将结果再恢复到函数的执行中，那么如此一来，我们的 `x` 就永远不会大于 3 了
...
这样以来，我们的 x 作为一个具有效应及效应处理器的**代数**，不仅为 AComponent 服务，还可以被复用于其他组件了
